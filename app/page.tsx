...
import { InterfaceArt } from "./ascii-art"
        ...
        <section id="features" className="w-full py-12 md:py-24 lg:py-32 bg-black border-b border-white/20">
          <div className="container px-4 md:px-6">
            ...
            <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-3 lg:gap-12">
              <div className="flex flex-col items-center space-y-4 rounded-none border border-white/20 p-6 h-full">
              ...
              <div className="flex flex-col items-center space-y-4 rounded-none border border-white/20 p-6 lg:col-span-2 h-full">
                <div className="text-2xl mb-2">👁️</div>
